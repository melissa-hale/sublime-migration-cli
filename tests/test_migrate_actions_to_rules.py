#!/usr/bin/env python
"""Test script for the migrate actions-to-rules presentation layer."""
import os
from src.sublime_migration_cli.presentation.factory import create_formatter
from src.sublime_migration_cli.commands.migrate.refactored.actions_to_rules import migrate_actions_to_rules_between_instances
